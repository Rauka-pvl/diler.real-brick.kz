...
@section('content')
    ...
    (function() {
        ...
        var emptyRowHtml = '<tr id="object-products-empty" class="text-admin-muted text-sm"><td colspan="3" class="py-4 px-3">Добавьте товары из каталога или поиска</td></tr>';
        ...
        function addProduct(bitrixId, productName, qty) {
            ...
            var emptyRowEl = document.getElementById('object-products-empty');
