...
@section('content')
    <div class="flex flex-wrap gap-3 mb-6">
        <a href="{{ route('dealer.objects.edit', $obj) }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-admin-accent text-white font-medium hover:bg-sky-600 transition">
