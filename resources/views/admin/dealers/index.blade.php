                        ...
                        <tr class="border-b border-admin-border hover:bg-slate-50/50 transition">
                            ...
                            <td class="py-4 px-6 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('admin.dealers.show', $dealer) }}" class="p-2 rounded-lg text-admin-muted hover:bg-admin-accent-soft hover:text-admin-accent transition" title="Просмотр">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
