...
@section('content')
    <div class="flex flex-wrap gap-3 mb-6">
        ...
        @if($client->dealer)
            <a href="{{ route('admin.dealers.show', $client->dealer) }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-admin-border text-admin-fg font-medium hover:bg-slate-50 transition">К диллеру</a>
        @endif
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-admin-border bg-slate-50/80">
                        ...
                        <th class="text-left py-3 px-4 text-sm font-semibold text-admin-fg">Диллер</th>
